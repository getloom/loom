<div class="prose">
	...
	<p>
		Some of felt-server's issues have no scheduled spot on the roadmap and no obvious use for
		discussion. We don't want these to clutter the GitHub issues, but we're open to feedback in our
		other dev community spaces and by email.
	</p>
	...
	<p>
		This power brings complexity, and currently, end-users of felt-server are exposed to this
		concept and have no options for a simpler experience. Fortunately, our system is being designed
		to support a fully customizable UI, so when it's ready, you'll be able to hide or disable this
